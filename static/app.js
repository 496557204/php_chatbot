const
    {createApp, ref, reactive, onMounted} = Vue;
const
    {ElMessage} = ElementPlus;
...
const
    app = createApp({
        setup() {
            ...
            const
                currentUser = reactive({username: '', role: ''});
            const
                activeMenu = ref('dashboard');
            const
...
// 解析JWT获取用户信息
                    const
                        tokenData = JSON.parse(atob(response.data.access_token.split('.')[1]));
...
> < / el - input >
< el - button
type = "primary" @ click = "encryptData"
style = "margin-top: 15px;" > 加密 < / el - button >
...
> < / el - input >
< el - button
type = "primary" @ click = "decryptData"
style = "margin-top: 15px;" > 解密 < / el - button >
...
placeholder = "输入要分配权限的用户名" > < / el - input >
< / el - form - item >
< el - form - item
label = "资源" >
< el - input
v - model = "permissionForm.resource"
placeholder = "输入资源名称（如data）" > < / el - input >
< / el - form - item >
< el - form - item
label = "操作" >
< el - select
...
< el - option
label = "读取"
value = "read" > < / el - option >
< el - option
label = "写入"
value = "write" > < / el - option >
< el - option
label = "删除"
...
< el - form - item >
< el - button
type = "primary" @ click = "assignPermission" > 分配权限 < / el - button >
< / el - form - item >
< / el - form >
< / div >

< h3
style = "margin-top: 30px;" > 当前用户权限 < / h3 >
